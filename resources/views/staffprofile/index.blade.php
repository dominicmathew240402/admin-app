        ...
        <div class="container">
            <div class="row g-5 align-items-center">
                <div class="col-lg-6 py-6 pb-0 pt-lg-0">
                    ...
                    <h1 class="display-3 mb-3">{{ $profiles->staffname }}</h1>
                    <h2 class="typed-text-output d-inline"></h2>
                    <div class="typed-text d-none">{{ $profiles->Jobs }}</div>
                    <div class="d-flex align-items-center pt-5">
                        <a href="" class="btn btn-primary py-3 px-4 me-5">Download CV</a>
                        <button type="button" class="btn-play" data-bs-toggle="modal"
                            data-src="{{ $profiles->youtube }}" data-bs-target="#videoModal">
                            <span></span>
                        </button>
                ...
                <div class="col-lg-6">
                    <img class="img-fluid" src="{{ $profiles->profilepic }}" alt="">
                </div>
            </div>
        </div>
    </div>
                ...
                <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="d-flex align-items-center mb-5">
                        <div class="years flex-shrink-0 text-center me-4">
                            <h1 class="display-1 mb-0">{{ $experiences->years }}</h1>
                            <h5 class="mb-0">Years</h5>
                        </div>
                        <h3 class="lh-base mb-0">{{ $experiences->detailsscope }}</h3>
                    </div>
                    <p class="mb-4">{{ $experience_details->details }}</p> 
                        ...
                        <div class="col-md-6">
                            <div class="skill mb-4">
                                <div class="d-flex justify-content-between">
                                    ...
                                    <h6 class="font-weight-bold">{{ $experience_details->statistics}}%</h6>
                                </div>
                                <div class="progress">
                                    <div class="progress-bar bg-primary" role="progressbar" aria-valuenow="{{ $experience_details->statistics}}" aria-valuemin="0" aria-valuemax="100"></div>
                                </div>
                            </div>
                            <div class="skill mb-4">
                                <div class="d-flex justify-content-between">
                                ...
                                <div class="progress">
                                    <div class="progress-bar bg-warning" role="progressbar" aria-valuenow="{{ $experience_details->statistics}}" aria-valuemin="0" aria-valuemax="100"></div>
                                </div>
                            </div>
                            <div class="skill mb-4">
                                <div class="d-flex justify-content-between">
                                ...
                                <div class="progress">
                                    <div class="progress-bar bg-danger" role="progressbar" aria-valuenow="{{ $experience_details->statistics}}" aria-valuemin="0" aria-valuemax="100"></div>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6">
                            ...
                            <div class="skill mb-4">
                                ...
                                <div class="progress">
                                    <div class="progress-bar bg-dark" role="progressbar" aria-valuenow="{{ $experience_details->statistics}}" aria-valuemin="0" aria-valuemax="100"></div>
                                </div>
                            </div>
                            <div class="skill mb-4">
                                <div class="d-flex justify-content-between">
                                ...
                                <div class="progress">
                                    <div class="progress-bar bg-info" role="progressbar" aria-valuenow="{{ $experience_details->statistics}}" aria-valuemin="0" aria-valuemax="100"></div>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="service-item d-flex flex-column flex-sm-row bg-white rounded h-100 p-4 p-lg-5">
                        ...
                        <div class="ms-sm-4">
                            ...
                            <h6 class="mb-3">Start from <span class="text-primary">RM{{ $experience_details->cost }}</span></h6>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-6 text-center text-md-end">
                        ...
                        <a href="{{ route('profiles.edit', $profiles->id) }}" class="btn btn-primary">Edit</a>
                        <a href="{{ route('profiles.create') }}" class="btn btn-primary">Add New User</a>
